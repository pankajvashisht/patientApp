...
import { LOGIN_USER, LOGOUT_USER, FORGOT_PASSWORD, RESET_PASSWORD } from '../actions';
...
export default function* rootSaga() {
	yield all([ fork(watchLoginUser), fork(watchLogoutUser), fork(watchForgotPassword), fork(watchResetPassword) ]);
}
