...
import { Row, Card, CardBody, CardTitle, FormGroup, Label, Button, Form } from 'reactstrap';
...
const AppInformation = React.memo(() => {
	...
	const addclass = (event) => {
		...
		updateAppInfo(currentInfo)
			.then(() => {
				NotificationManager.success('Infotrmation Updated Successfully', 'Success', 3000, null, null, '');
			})
			.catch((err) => {
				if (err.response) {
