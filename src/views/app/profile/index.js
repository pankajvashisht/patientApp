...
import {
  ...
  TabPane,
  CardTitle,
   Input,  FormGroup, Label, Button, Form
} from "reactstrap";
              ...
              <TabPane tabId="1">
                <Row>
                  <Colxx xxs="12" lg="4" className="mb-4 col-left">
                    <Card className="mb-4">
                      ...
                      <SingleLightbox thumb={adminDetails.profile ? adminDetails.profile:'/assets/img/profile-pic.jpg'} large={adminDetails.profile ? adminDetails.profile:'/assets/img/profile-pic.jpg'} className="card-img-top" />

                      <CardBody>
                <p className="text-muted text-small mb-2">{adminDetails.first_name} {adminDetails.last_name}</p>
                        <p className="mb-3">
                          Admin Profile
                        </p>
                    ...
                    <Card className="mb-4">
                      <CardBody>
                        ...
                        <div className="remove-last-border remove-last-margin remove-last-padding">
                          <div>
					<b> Name </b> : {adminDetails.first_name} {adminDetails.last_name}
				</div>
				<hr />
				<div>
				...
				<div>
					<b> Status </b> : <StatusUpdate
											table="users"
											onUpdate={(data) => adminDetails.status = (adminDetails.status === 1)?0:1}
											data={adminDetails}
										/>
				</div>
				<hr />
				...
				<Colxx xxs="12">
					<Card>
						<CardBody>
							...
							<Form onSubmit={updateAdmin} autoComplete="off">
								<FormGroup row>
									<Colxx sm={6}>
										<FormGroup>
                                    ...
                                    <Colxx sm={12}>
										<FormGroup>
											<Label for="exampleEmailGrid">Profile</Label>
											<Input
												type="file"
												onChange={({ target }) => handleInput('image', target.files[0])}
												placeholder="Profile"
											/>
										</FormGroup>
									</Colxx>
